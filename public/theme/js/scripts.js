  ...
  var sidebar_dropdown = function() {
    if($(".main-sidebar").length) {
      ...
      $(".main-sidebar .sidebar-menu li a.has-dropdown").off('click').on('click', function() {
        ...
        $('.main-sidebar .sidebar-menu li.active > .dropdown-menu').slideUp(0, function() {
        ...
        if(active==true) {
          ...
          me.parent().find('> .dropdown-menu').slideUp(0, function() {
            update_sidebar_nicescroll();
            return false;
          });
        }else{
          me.parent().addClass('active');
          me.parent().find('> .dropdown-menu').slideDown(0, function() {
            update_sidebar_nicescroll();
            return false;
          });
        }
      ...
      $('.main-sidebar .sidebar-menu li.active > .dropdown-menu').slideDown(0, function() {
        update_sidebar_nicescroll();
        return false;
      });
    }
